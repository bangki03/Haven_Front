...
export class Keypoints extends paper.Group {
  ...
  addKeypoint(keypoint) {
    ...
    if (Object.prototype.hasOwnProperty.call(this._labelled, 'indexLabel')) {
      keypoint.indexLabel = -1;
    } else {
      this._labelled[indexLabel] = keypoint;
    }
  ...
  deleteKeypoint(keypoint) {
    ...
    // }
    if (Object.prototype.hasOwnProperty.call(this._edges, 'indexLabel')) {
      this._edges[indexLabel].forEach(e => this.removeLine([e, indexLabel]));
    }
  ...
  _addEdgeIndex(index1, index2) {
    ...
    if (Object.prototype.hasOwnProperty.call(this._edges, 'index1')) {
  ...
  _drawLines(keypoint) {
    ...
    if (!Object.prototype.hasOwnProperty.call(this._edges, 'keypoint.indexLabel')) return;
