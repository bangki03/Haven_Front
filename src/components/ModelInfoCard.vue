<template>
    <div style="height: 55px; width:100%; display:grid; grid-template-columns: 3.5fr 3.5fr 3fr 3fr 2fr 2fr 1fr 2fr 1.5fr 1fr 1fr 1fr 1fr; justify-items: stretch; justify-content: center; align-items: center; overflow:hidden">
