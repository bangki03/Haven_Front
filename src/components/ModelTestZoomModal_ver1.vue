<!-- Mask 갯수에 따라 동적으로 개발하기 위한 소스. But 실패-->
<template>
...
export default{
    ...
    methods: {
        ...
        initCanvas_with_Mask_ver3() {
            ...
            this.image.raster.onLoad = () => {
                ...
                const maskPromises = this.maskList.map((maskItem, index) => {
                    ...
                    maskItem.maskData = this.mask2png(this.InferenceData.mask[index].data_base64Decoded, this.ColorHEX2RGB(this.colorList[index]))
                    console.log("[mask2png] index: ", index)
                    console.log("[mask2png]", maskItem.maskData)
        ...
        initCanvas_with_Mask_ver2() {
            ...
            this.image.raster.onLoad = () => {
                ...
                for(let i=0; i<this.maskList.length; i++) {
                    ...
                    this.maskList[i].maskData = this.mask2png(this.InferenceData.mask[i].data_base64Decoded, this.ColorHEX2RGB(this.colorList[i]))
        ...
        //     let maskData1 = this.mask2png(this.InferenceData.mask[0].data_base64Decoded, this.ColorHEX2RGB(this.colorList[0]))
        //     maskImage1.src = maskData1

        //     let maskData2 = this.mask2png(this.InferenceData.mask[1].data_base64Decoded, this.ColorHEX2RGB(this.colorList[1]))
        //     maskImage2.src = maskData2

        //     let maskData3 = this.mask2png(this.InferenceData.mask[2].data_base64Decoded, this.ColorHEX2RGB(this.colorList[2]))
